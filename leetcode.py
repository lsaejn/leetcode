...
HEADERS = {
    ...
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36',  # NOQA
}
...
class Leetcode:
    ...
    def load_submissions(self):
        ...
        while True:
            ...
            total+=len(data['submissions_dump'])
            if total>=40:
                break
            if data['has_next']:
                offset += limit

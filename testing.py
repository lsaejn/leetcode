...
#
# Author: CJ
# Github: https://github.com/lsaejn
# Repo:   https://github.com/lsaejn/leetcode
#
import requests
import configparser
import os
...
class Leetcode:
    ...
    def load_items_from_api(self):
        ...
        api_url = 'https://leetcode-cn.com/problemset/all/'
        ...
        driver = webdriver.Chrome(chrome_options=options, executable_path=executable_path)
        driver.get(api_url)
        op_selector=driver.find_elements_by_id('form-control')
